...
# ---- Load data ----
movies = pickle.load(open("movies_list.pkl", "rb"))  # Requires 'title' and 'id'
...
def recommend(movie_title):
    ...
    recommended = []
    for i in distances[1:6]:  # ✅ Show top 5 recommendations instead of 3
...
if st.button("Show Recommendations"):
    ...
    cols = st.columns(len(results))  # This will automatically use 5 columns now
